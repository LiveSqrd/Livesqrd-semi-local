...
exports.run = function(){
	...
	socketClient.onevent = function(packet){
		//console.log("socketClient",packet.data[0],packet.data[1]);	
	...
	io.use(function(socket,next){
		...
		if(!socket._onevent){
			...
			socket.onevent = function(packet){
				...
				socketClient.emit(packet.data[0],packet.data[1],function(a,b){
					console.log("socketClient emit return",a,b);
				})
